...
echo ===========================================
echo FastClipboard v1.0 - Native Build Script
echo ===========================================
echo.
...
:: Compile
echo.
echo Compiling FastClipboard v1.0 with Win32 Clipboard API...
echo =====================================================
cl /LD /Fe:build\fastclipboard.dll ^
    native\fastclipboard.cpp ^
    user32.lib ^
    /I"%JAVA_HOME%\include" ^
...
copy build\fastclipboard.dll src\main\resources\native\fastclipboard.dll
...
echo =====================================================
echo.
echo FastClipboard v1.0 DLL created with:
echo - Win32 OpenClipboard/GetClipboardData/SetClipboardData
echo - UTF-8/Unicode text support
